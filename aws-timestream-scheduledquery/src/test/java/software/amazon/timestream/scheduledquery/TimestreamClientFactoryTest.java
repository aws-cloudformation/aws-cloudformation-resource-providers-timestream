...
public class TimestreamClientFactoryTest {
    ...
    @Test
    public void getTimestreamClientTest() {
    ...
    @Test
    public void getTimestreamClientThrowWhenInternalServerFailureTest() {
    ...
    @Test
    public void getTimestreamClientThrowWhenInvalidRequestTest() {
